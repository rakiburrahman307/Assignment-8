...
const CardDetails = () => {
  ...
  const { details_picture, title, description, category, text_color_1, text_color_2, text_color_3, text_color_4, price } = card;
  ...
  return (
    <div className="card w-auto mx-auto overflow-hidden px-5 md:px-24 card-compact bg-base-100 shadow-xl">
      ...
      <button onClick={handleDonation} className="btn w-40 absolute bottom-[380px] left-10 md:bottom-40 md:left-32 border-none text-white" style={{ background: text_color_1 || text_color_2 || text_color_3 || text_color_4 }}>Donate ${price}</button>
